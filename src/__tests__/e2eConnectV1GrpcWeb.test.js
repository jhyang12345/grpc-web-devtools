 ...
 */
// Real-library end-to-end matrix: Connect-ES v1 (protobuf-es v1) with createGrpcWebTransport
...
describe("connect-v1-grpc-web", () => {
  defineStackSuite(STACKS["connect-v1-grpc-web"]);
});
